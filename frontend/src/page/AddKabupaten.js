...
export default function AddKabupaten () {
    ...
    const handleSubmit = async (e) => {
        try{
            ...
            formData.set("idProvinsi", form.idProvinsi);
            ...
            const response = await API.post("/kabupaten", formData, config)
    ...
    return(
        <dev>
            <h2 style={{marginLeft:"4em", marginTop:"0.5em", marginBottom:"1em"}}>Add Kabupaten</h2>
            <Container>
